...
export const dashboardTemplate = (furnitures) => html`
        ...
        <div class="row space-top">
            ${furnitures.map(furnituresTemplate)}
        </div>`;

export const myFurnituresTemplate = (furnitures) => html`
<div class="row space-top">
    <div class="col-md-12">
        <h1>My Furniture</h1>
...
const furnituresTemplate = (furniture) => html`
        <div class="col-md-4">
...
export const detailsTemplate = (furniture, isOwner, user) => html`
        <div class="row space-top">
            <div class="col-md-12">
